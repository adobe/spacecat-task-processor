 ...
 * confidence signal (retained for callers/tests; not consumed by the P856
 * validation path), and the site's registrable domain. Downstream
 * Wikipedia/Wikidata entity validation is
