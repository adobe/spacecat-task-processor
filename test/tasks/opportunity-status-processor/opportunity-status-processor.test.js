  ...
  describe('Bot Protection Detection', () => {
    ...
    it('should detect bot protection and send Slack alert when scrapes are blocked', async function () {
      ...
      try {
        ...
        expect(slackMessage).to.include('cloudflare');
        expect(slackMessage).to.include('2/2'); // Both URLs blocked
    ...
    it('should handle partial bot protection blocking', async () => {
      ...
      try {
        ...
        expect(slackMessage).to.include('Bot Protection Detected');
        expect(slackMessage).to.include('2/3'); // 2 out of 3 blocked
        expect(slackMessage).to.include('67%'); // Percentage
    ...
    it('should use dev IPs for non-production environments', async () => {
      ...
      try {
        ...
        // Verify dev IPs are used via Slack
        expect(mockSlackClient.postMessage).to.have.been.called;
        ...
        expect(slackMessage).to.not.include('3.218.16.42'); // Prod IP
